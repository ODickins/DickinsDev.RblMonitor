using DickinsDev.Utilities.Smtp;
...
namespace DickinsDev.RblMonitor.WebUI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, Data.DataContext data)
        {
